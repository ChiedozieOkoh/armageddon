...
pub fn serialise_opcode(buffer: &mut String, opcode: &Opcode){
   match opcode{
      Opcode::_16Bit(B16::UNDEFINED) => buffer.push_str("UDF"),
      Opcode::_16Bit(B16::ADCS) => buffer.push_str("ADCS"),
      Opcode::_16Bit(B16::ADD_Imm3) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::ADD_Imm8) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::ADDS_REG) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::ADDS_REG_T2) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::ADD_REG_SP_IMM8) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::INCR_SP_BY_IMM7) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::INCR_SP_BY_REG) => buffer.push_str("ADD"),
      Opcode::_16Bit(B16::ADR) => buffer.push_str("ADR"),
      Opcode::_16Bit(B16::ANDS) => buffer.push_str("AND"),
      Opcode::_16Bit(B16::ASRS_Imm5) => buffer.push_str("ASR"),
      Opcode::_16Bit(B16::ASRS_REG) => buffer.push_str("ASR"),
      Opcode::_16Bit(B16::SVC) => buffer.push_str("SVC"),
      Opcode::_16Bit(B16::BEQ) => buffer.push_str("BEQ"),
      Opcode::_16Bit(B16::BNEQ) => buffer.push_str("BNE"),
      Opcode::_16Bit(B16::B_CARRY_IS_SET) => buffer.push_str("BCS"),
      Opcode::_16Bit(B16::B_CARRY_IS_CLEAR) => buffer.push_str("BCC"),
      Opcode::_16Bit(B16::B_IF_NEGATIVE) => buffer.push_str("BMI"),
      Opcode::_16Bit(B16::B_IF_POSITIVE) => buffer.push_str("BPL"),
      Opcode::_16Bit(B16::B_IF_OVERFLOW) => buffer.push_str("BVS"),
      Opcode::_16Bit(B16::B_IF_NO_OVERFLOW) => buffer.push_str("BVC"),
      Opcode::_16Bit(B16::B_UNSIGNED_HIGHER) => buffer.push_str("BHI"),
      Opcode::_16Bit(B16::B_UNSIGNED_LOWER_OR_SAME) => buffer.push_str("BLS"),
      Opcode::_16Bit(B16::B_GTE) => buffer.push_str("BGE"),
      Opcode::_16Bit(B16::B_LTE) => buffer.push_str("BLE"),
      Opcode::_16Bit(B16::B_GT) => buffer.push_str("BGT"),
      Opcode::_16Bit(B16::B_LT) => buffer.push_str("BLT"),
      Opcode::_16Bit(B16::B_ALWAYS) => buffer.push_str("BAL"),
      Opcode::_16Bit(B16::BIT_CLEAR_REGISTER) => buffer.push_str("BIC"),
      Opcode::_16Bit(B16::BREAKPOINT) => buffer.push_str("BKPT"),
      Opcode::_16Bit(B16::BR_LNK_EXCHANGE) => buffer.push_str("BLX"),
      Opcode::_16Bit(B16::BR_EXCHANGE) => buffer.push_str("BX"),
      Opcode::_16Bit(B16::CMP_NEG_REG) => buffer.push_str("CMN"),
      Opcode::_16Bit(B16::CMP_Imm8) => buffer.push_str("CMP"),
      Opcode::_16Bit(B16::CMP_REG_T1) => buffer.push_str("CMP"),
      Opcode::_16Bit(B16::CMP_REG_T2) => buffer.push_str("CMP"),
      Opcode::_16Bit(B16::CPS) => {},//the instruction name is known by decode_operands
      Opcode::_16Bit(B16::XOR_REG) => buffer.push_str("EOR"),
      Opcode::_16Bit(B16::LDM) => buffer.push_str("LDM"),//load from base address sequencialy to register list
      Opcode::_16Bit(B16::LDR_Imm5) => buffer.push_str("LDR"),
      Opcode::_16Bit(B16::LDR_SP_Imm8) => buffer.push_str("LDR"),
      Opcode::_16Bit(B16::LDR_PC_Imm8) => buffer.push_str("LDR"),
      Opcode::_16Bit(B16::LDR_REGS) => buffer.push_str("LDR"),
      Opcode::_16Bit(B16::LDRB_Imm5) => buffer.push_str("LDRB"),
      Opcode::_16Bit(B16::LDRB_REGS) => buffer.push_str("LDRB"),
      Opcode::_16Bit(B16::LDRH_Imm5) => buffer.push_str("LDRH"),
      Opcode::_16Bit(B16::LDRH_REGS) => buffer.push_str("LDRH"),
      Opcode::_16Bit(B16::LDRSB_REGS) => buffer.push_str("LDRSB"),
      Opcode::_16Bit(B16::LDRSH_REGS) => buffer.push_str("LDRSH"),
      Opcode::_16Bit(B16::LSL_Imm5) => buffer.push_str("LSL"),
      Opcode::_16Bit(B16::LSL_REGS) => buffer.push_str("LSL"),
      Opcode::_16Bit(B16::LSR_Imm5) => buffer.push_str("LSR"),
      Opcode::_16Bit(B16::LSR_REGS) => buffer.push_str("LSR"),
      Opcode::_16Bit(B16::MOV_Imm8) => buffer.push_str("MOV"),
      Opcode::_16Bit(B16::MOV_REGS_T1) => buffer.push_str("MOV"),
      Opcode::_16Bit(B16::MOV_REGS_T2) => buffer.push_str("MOV"),
      Opcode::_16Bit(B16::MUL) => buffer.push_str("MUL"),
      Opcode::_16Bit(B16::MVN) => buffer.push_str("MVN"),
      Opcode::_16Bit(B16::NOP) => buffer.push_str("NOP"),
      Opcode::_16Bit(B16::ORR) => buffer.push_str("ORR"),
      Opcode::_16Bit(B16::POP) => buffer.push_str("POP"),
      Opcode::_16Bit(B16::PUSH) => buffer.push_str("PUSH"),
      Opcode::_16Bit(B16::REV) => buffer.push_str("REV"),
      Opcode::_16Bit(B16::REV_16) => buffer.push_str("REV16"),
      Opcode::_16Bit(B16::REVSH) => buffer.push_str("REVSH"),
      Opcode::_16Bit(B16::ROR) => buffer.push_str("ROR"),
      Opcode::_16Bit(B16::RSB) => buffer.push_str("RSB"),
      Opcode::_16Bit(B16::SBC) => buffer.push_str("SBC"),
      Opcode::_16Bit(B16::SEV) => buffer.push_str("SEV"),
      Opcode::_16Bit(B16::STM) => buffer.push_str("STM"),
      Opcode::_16Bit(B16::STR_Imm5) => buffer.push_str("STR"),
      Opcode::_16Bit(B16::STR_Imm8) => buffer.push_str("STR"),
      Opcode::_16Bit(B16::STR_REG) => buffer.push_str("STR"),
      Opcode::_16Bit(B16::STRB_Imm5) => buffer.push_str("STRB"),
      Opcode::_16Bit(B16::STRB_REG) => buffer.push_str("STRB"),
      Opcode::_16Bit(B16::STRH_Imm5) => buffer.push_str("STRH"),
      Opcode::_16Bit(B16::STRH_REG) => buffer.push_str("STRH"),
      Opcode::_16Bit(B16::SUB_Imm3) => buffer.push_str("SUB"),
      Opcode::_16Bit(B16::SUB_Imm8) => buffer.push_str("SUB"),
      Opcode::_16Bit(B16::SUB_REG) => buffer.push_str("SUB"),
      Opcode::_16Bit(B16::SUB_SP_Imm7) => buffer.push_str("SUB"),
      Opcode::_16Bit(B16::SXTB) => buffer.push_str("SXTB"),
      Opcode::_16Bit(B16::SXTH) => buffer.push_str("SXTH"),
      Opcode::_16Bit(B16::TST) => buffer.push_str("TST"),
      Opcode::_16Bit(B16::UXTB) => buffer.push_str("UXTB"),
      Opcode::_16Bit(B16::UXTH) => buffer.push_str("UXTH"),
      Opcode::_16Bit(B16::WFE) => buffer.push_str("WFE"),
      Opcode::_16Bit(B16::WFI) => buffer.push_str("WFI"),
      Opcode::_16Bit(B16::YIELD) => buffer.push_str("YIELD"),
      Opcode::_32Bit(B32::UNDEFINED) => buffer.push_str("UDF.W"),
      Opcode::_32Bit(B32::BR_AND_LNK) => buffer.push_str("BL"),
      Opcode::_32Bit(B32::DMB) => buffer.push_str("DMB"),
      Opcode::_32Bit(B32::DSB) => buffer.push_str("DSB"),
      Opcode::_32Bit(B32::ISB) => buffer.push_str("ISB"),
      Opcode::_32Bit(B32::MRS) => buffer.push_str("MRS"),
      Opcode::_32Bit(B32::MSR) => buffer.push_str("MSR")
   }
}
